...
format:
  pdf:
    ...
    header-includes: |
      ...
      \hypersetup{linkcolor=accentblue,citecolor=accentblue,urlcolor=accentblue}
      \pagestyle{fancy}
      \fancyhf{}
      ...
      \fancyfoot[L]{\small\textcolor{lightgray}{DOI: 10.5281/zenodo.19431281}}
...
\textit{Zenodo DOI:} 10.5281/zenodo.19431281\\[0.2cm]
...
: LDHA/LDHC trans-eQTL across GTEx v8 tissues (chr11:18,411,103 C>T). NES: normalised effect size (negative = lower LDHC expression in Eastern allele carriers). eQTLGen: independent whole-blood replication cohort. {#tbl-eqtl}
...
**Figure 4.** LDHA/LDHC trans-eQTL. Panel A: NES by tissue (GTEx v8). Panel B: eQTLGen replication (*n* = 31,684; Z = 75.96; *p* = 3.27 × 10^−310^). Panel C: regional association plot chr11:18.35–18.55 Mb.
...
\vspace{0.5cm}
\begin{center}
\textcolor{lightgray}{\small EastWestDM v7.1 · García-Morán 2026 · Universidad de Valladolid · DOI: 10.5281/zenodo.19431281}
\end{center>
