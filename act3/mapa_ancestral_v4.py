#!/usr/bin/env python3
# =============================================================
# MAPA MUNDIAL — Ancestral NCDN variant frequency  v4
# chr1:35,565,741 — Global frequency distribution
# Correcciones v4:
#   - Colorbar arriba izquierda sobre Canadá (zona limpia)
#   - Beringia recortada a xlim
#   - xlim -128 a 148
#   - Etiquetas más separadas
# =============================================================
...
# límites primero para que clipping funcione
ax.set_xlim(-128, 148)
ax.set_ylim(-38, 78)
...
# Segmento asiático: Siberia → Chukotka (dentro de xlim=148)
bx_a = [84.7, 108.0, 128.0, 145.0]
...
# --- 6. COLORBAR — arriba izquierda sobre Canadá -----------
...
for frac, lbl in [(0.03, "NFE\n3%"), (0.70, "AFR\n~70%"), (1.00, "100%")]:
    ...
    ax_cb.text(frac, 1.4, lbl,
               transform=ax_cb.transAxes,
               ha="center", va="bottom",
               fontsize=4.0, color="#555555")

# Marco blanco alrededor de la colorbar para legibilidad
from matplotlib.patches import FancyBboxPatch
# (el inset ya tiene fondo blanco por set_facecolor)
...
for fmt, d in [("png", 300), ("pdf", 300)]:
    p = os.path.join(out, f"figure6_world_map_v4.{fmt}")
