...
\subsection{Eastern and Western variant
...
\subsection{SLC2A3 invariance across 430,000
...
\subsection{LDHA/LDHC trans-eQTL across seven
...
\subsection{Global frequency distribution: an ancestral variant with
...
\subsection{Two adaptive solutions of equivalent
...
plant-based substrates: ACACA lipogenesis, PPARGC1A thermogenesis, PPARγ
...
\subsection{The European divergence began before
...
\subsection{From regulatory variant to glycolytic
...
\subsection{The Beringia bottleneck: cold selection as amplifier, not
...
\subsection{Three clinically undercharacterised populations, one shared
...
\subsection{The human singularity and its metabolic
...
\subsection{Archaic genome processing and variant
...
\subsection{SLC2A3 conservation
...
\subsection{Statistical analysis and figure
...
10.5281/zenodo.19431281). Raw archaic genome data: PRJEB10597 (Sima de
